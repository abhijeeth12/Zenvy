      ...
      <div style={{ 
        ...
        <div style={{ width: '100%', maxWidth: '360px', padding: '2rem' }}>
          ...
          <div style={{ marginBottom: '3.5rem' }}>
            ...
            <p style={{ color: '#8a7d76', fontSize: '1rem', marginTop: '0.5rem', fontWeight: 400 }}>Create an account to join collective orders.</p>
          </div>
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#6a5d55', letterSpacing: '0.02em' }}>Full Name</label>
              <input 
                type="text" 
                value={displayName}
            ...
            {/* Password */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#6a5d55', letterSpacing: '0.02em' }}>Initialize Password</label>
              <input 
                type="password" 
                value={password}
          ...
          <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
            <span style={{ fontSize: '0.9rem', color: '#8a7d76' }}>
              Already have an account?{' '}
              <Link to="/login" style={{ color: '#c96442', fontWeight: 600, textDecoration: 'none' }}>
                Sign In
              </Link>
            </span>
          </div>
